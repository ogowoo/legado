...
### 1. AI助手是什么？
AI助手是阅读3.0集成的智能功能，可以自动修复书籍内容中的乱码、缺字、错别字等问题，还能智能生成替换净化规则。

### 2. 如何使用AI修复功能？
* 首先需要在"我的"——"AI助手"中启用AI功能并配置API Key
* 在阅读界面长按需要修复的文字
* 选择"AI修复"菜单
* 查看修复对比后确认应用

### 3. AI修复支持哪些AI提供商？
目前支持以下AI提供商（推荐使用国内提供商，响应更快）：
* **DashScope（通义千问）** - 阿里云，有免费额度
* **DeepSeek** - 价格低，中文效果好
* **智谱AI（GLM）** - 有免费额度
* **百度千帆** - 有免费额度
* **SiliconFlow** - 多种免费模型
...
* 注册账号并创建应用
* 在应用管理页面获取API Key
* 将API Key填入阅读APP的AI设置中

### 5. AI生成的替换规则是什么？
当您使用AI修复内容后，可以选择"生成替换规则"，AI会自动分析修复内容，生成通用的正则表达式规则，用于自动处理同类问题。

### 6. AI功能会消耗很多流量吗？
AI修复需要联网调用API，每次修复大约消耗1-5KB流量，流量消耗很小。

### 7. AI功能安全吗？我的书籍内容会被泄露吗？
* 书籍内容会发送到您选择的AI提供商进行处理
* 建议使用国内可信的AI服务提供商
* 敏感内容请谨慎使用AI功能
