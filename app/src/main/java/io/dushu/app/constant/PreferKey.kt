...
object PreferKey {
    ...
    const val aiContentRepair = "aiContentRepair"
    const val aiContentRepairEnabled = "aiContentRepairEnabled"
    const val aiRepairProvider = "aiRepairProvider"
    const val aiRepairApiKey = "aiRepairApiKey"
    const val aiRepairApiUrl = "aiRepairApiUrl"
    const val aiRepairModel = "aiRepairModel"
    ...
    const val aiAutoSaveCache = "aiAutoSaveCache"
    const val aiPromptGenerateRules = "aiPromptGenerateRules"
    const val aiDefaultGeneralRule = "aiDefaultGeneralRule"
    const val aiAutoApplyToBook = "aiAutoApplyToBook"
