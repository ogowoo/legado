...
import io.dushu.app.BuildConfig
...
import io.dushu.app.constant.Status
...
import io.dushu.app.data.entities.BookProgress
...
import io.dushu.app.help.TTS
import io.dushu.app.help.book.BookHelp
import io.dushu.app.help.book.ContentProcessor
import io.dushu.app.help.book.isAudio
import io.dushu.app.help.book.isEpub
import io.dushu.app.help.book.isLocal
import io.dushu.app.help.book.isLocalTxt
import io.dushu.app.help.book.isMobi
...
import io.dushu.app.help.config.ReadTipConfig
import io.dushu.app.help.coroutine.Coroutine
import io.dushu.app.help.source.getSourceType
...
import io.dushu.app.model.analyzeRule.AnalyzeRule.Companion.setCoroutineContext
import io.dushu.app.utils.GSON
import io.dushu.app.utils.fromJsonObject
import io.dushu.app.utils.isJsonObject
import io.dushu.app.model.localBook.EpubFile
import io.dushu.app.model.localBook.MobiFile
import io.dushu.app.receiver.NetworkChangedListener
import io.dushu.app.receiver.TimeBatteryReceiver
import io.dushu.app.service.BaseReadAloudService
import io.dushu.app.ui.about.AppLogDialog
import io.dushu.app.ui.book.bookmark.BookmarkDialog
import io.dushu.app.ui.book.changesource.ChangeBookSourceDialog
import io.dushu.app.ui.book.changesource.ChangeChapterSourceDialog
import io.dushu.app.ui.book.info.BookInfoActivity
import io.dushu.app.ui.book.read.config.AutoReadDialog
import io.dushu.app.ui.book.read.config.BgTextConfigDialog.Companion.BG_COLOR
import io.dushu.app.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_ACCENT_COLOR
import io.dushu.app.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_COLOR
import io.dushu.app.ui.book.read.config.MoreConfigDialog
import io.dushu.app.ui.book.read.config.ReadAloudDialog
import io.dushu.app.ui.book.read.config.ReadStyleDialog
import io.dushu.app.ui.book.read.config.TipConfigDialog.Companion.TIP_COLOR
import io.dushu.app.ui.book.read.config.TipConfigDialog.Companion.TIP_DIVIDER_COLOR
import io.dushu.app.ui.book.read.page.ContentTextView
import io.dushu.app.ui.book.read.page.ReadView
import io.dushu.app.ui.book.read.page.delegate.ScrollPageDelegate
import io.dushu.app.ui.book.read.page.entities.PageDirection
import io.dushu.app.ui.book.read.page.entities.TextPage
import io.dushu.app.ui.book.read.page.provider.ChapterProvider
import io.dushu.app.ui.book.read.page.provider.LayoutProgressListener
import io.dushu.app.ui.book.searchContent.SearchContentActivity
import io.dushu.app.ui.book.searchContent.SearchResult
import io.dushu.app.model.SourceCallBack
import io.dushu.app.ui.book.source.edit.BookSourceEditActivity
import io.dushu.app.ui.book.toc.TocActivityResult
import io.dushu.app.ui.book.toc.rule.TxtTocRuleDialog
import io.dushu.app.ui.browser.WebViewActivity
import io.dushu.app.ui.dict.DictDialog
...
import io.dushu.app.ui.replace.edit.ReplaceEditActivity
import io.dushu.app.ui.widget.PopupAction
import io.dushu.app.ui.widget.dialog.PhotoDialog
import io.dushu.app.utils.ACache
import io.dushu.app.utils.Debounce
import io.dushu.app.utils.LogUtils
import io.dushu.app.utils.NetworkUtils
import io.dushu.app.utils.StartActivityContract
import io.dushu.app.utils.applyOpenTint
import io.dushu.app.utils.buildMainHandler
import io.dushu.app.utils.dismissDialogFragment
import io.dushu.app.utils.getPrefBoolean
import io.dushu.app.utils.getPrefString
import io.dushu.app.utils.hexString
import io.dushu.app.utils.iconItemOnLongClick
import io.dushu.app.utils.invisible
import io.dushu.app.utils.isAbsUrl
import io.dushu.app.utils.isTrue
import io.dushu.app.utils.launch
import io.dushu.app.utils.navigationBarGravity
import io.dushu.app.utils.observeEvent
import io.dushu.app.utils.observeEventSticky
...
import io.dushu.app.utils.startActivityForBook
import io.dushu.app.utils.sysScreenOffTime
import io.dushu.app.utils.throttle
...
import io.dushu.app.model.analyzeRule.AnalyzeUrl.Companion.paramPattern
import io.dushu.app.ui.login.SourceLoginJsExtensions
