package io.dushu.app.ui.book.read.page.provider
...
import io.dushu.app.help.book.BookContent
...
import io.dushu.app.ui.book.read.page.entities.column.ImageColumn
import io.dushu.app.ui.book.read.page.entities.column.TextColumn
import io.dushu.app.utils.dpToPx
import io.dushu.app.utils.fastSum
import io.dushu.app.utils.getTextWidthsCompat
...
import io.dushu.app.constant.AppPattern.noWordCountRegex
import io.dushu.app.data.appDb
import io.dushu.app.ui.book.read.page.entities.TextLine.Companion.atLeastApi28
import io.dushu.app.ui.book.read.page.entities.column.TextHtmlColumn
import io.dushu.app.ui.book.read.page.provider.ChapterProvider.reviewChar
import io.dushu.app.ui.book.read.page.provider.ChapterProvider.srcReplaceChar
import io.dushu.app.ui.book.read.page.provider.ChapterProvider.srcReplaceCharC
import io.dushu.app.ui.book.read.page.provider.ChapterProvider.srcReplaceCharD
...
import io.dushu.app.ui.book.read.page.entities.column.BaseColumn
            ...
            if (AppConfig.aiAutoRepairEnabled) {
                try {
                    ...
                    if (repairedText != text) {
                        AppLog.put("AI内容修正成功: 原文=${text.take(30)}... -> 修正=${repairedText.take(30)}...")
                    } else {
                        AppLog.put("AI内容修正: 段落无需修正")
                    }
                    text = repairedText
                } catch (e: Exception) {
